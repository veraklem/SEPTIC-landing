 ...
 * кнопкой «Купить на Ozon» (site.ozon.url - карточка флакона 100 мл). Видна
 * только на мобильных/планшетах (lg:hidden), z-index ниже Navbar/мобильного
 * меню и ниже модалок (z-[100]). Без анимации - не нужен prefers-reduced-motion
 * спецкейс. Нижний зазор под ней добавлен в CtaFooter (pb), чтобы панель не
 * перекрывала футер.
 */
